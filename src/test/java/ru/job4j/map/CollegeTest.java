...
class CollegeTest {
    ...
    public void whenAccountIsOptionalEmpty() {
        Map<Student, Set<CollegeSubject>> students = Map.of(
                new Student("Student1", "000001", "201-18-15"),
                Set.of(
                        new CollegeSubject("Math", 70),
                        new CollegeSubject("English", 85)
                ),
                new Student("Student2", "000002", "201-18-15"),
                Set.of(
                        new CollegeSubject("Economic", 75),
                        new CollegeSubject("Sociology", 65)
                )
        );
