...
import java.util.List;
  ...
  public class AnalyzeTest {
    ...
    public void whenListOfPupilAverage() {
        ...
        assertThat(average, is(List.of(new Tuple("Ivanov", 100),
                new Tuple("Petrov", 60) // ok
        )));
    }
    ...
    public void whenBestPupil() {
        ...
        assertThat(best, is(new Tuple("Ivanov", 200D))); // ok
    }
   ...
   @Test
    ...
    public void whenListOfSubjectAverage() {
        ...
        assertThat(average, is(List.of(new Tuple("Lang", 80D),
                new Tuple("Math", 80D)
        )));
    }
   }